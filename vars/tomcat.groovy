   ...
   stage('uploade to ec2') {
     steps{
      ...
      sh '''
        ...
        scp -i o StrictHostKeyChecking=no Downloads/Dockerfile  ubuntu@43.205.241.220:/tmp
        ssh -i o StrictHostKeyChecking=no ubuntu@43.204.24.104 'systemctl restart tomcat9'
       '''
